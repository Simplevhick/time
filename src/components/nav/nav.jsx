...
const Nav = () => {
  ...
  return (
    <nav>
      ...
      >
        <div className="lg:h-[25rem] lg:w-[31rem] lg:bg-black lg:bg-opacity-20 lg:border-none lg:border-2 lg:absolute lg:top-[32rem] lg:left-[2rem] h-[11.5rem] w-[14rem] bg-black bg-opacity-15 border-none absolute top-[17rem] left-[1rem] sm:h-[11.5rem] sm:w-[14rem] sm:bg-black sm:bg-opacity-15 sm:border-none sm:absolute sm:top-[17rem] sm:left-[1rem] md:h-[17.5rem] md:w-[16.5rem] md:bg-black md:bg-opacity-20 md:border-none md:absolute md:top-[18rem] md:left-[1.6rem]">
          <div>
