...
const Nav = () => {
  ...
  return (
    <nav>
      ...
      >
        <div className="lg:h-[25rem] lg:w-[31rem] lg:bg-black lg:bg-opacity-20 lg:border-none lg:border-2 lg:absolute lg:top-[32rem] lg:left-[2rem] h-[11.5rem] w-[14rem] bg-black bg-opacity-15 border-none absolute top-[17rem] left-[1rem] ">
          <div>
