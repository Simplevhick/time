...
const Nav = () => {
  ...
  return (
    <nav>
      ...
      <div
        className="lg:max-w-full lg:bg-contain lg:bg-no-repeat lg:h-[60rem] md:max-w-full md:bg-cover md:bg-no-repeat md:h-[46rem] min-w-full bg-cover bg-no-repeat h-[27rem]"
        style={{
